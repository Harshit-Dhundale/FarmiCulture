...
const About = () => {
  return (
    <>
      {/* Hero header is OUTSIDE the container, so it can span full width */}
      <HeroHeader
        title="About FarmiCulture"
        subtitle="Learn more about our mission, inspiration, and how we power sustainable agriculture."
        backgroundImage="/assets/head/about.jpg"  // Corrected path
      />

      {/* Now your about content is in a narrower container */}
